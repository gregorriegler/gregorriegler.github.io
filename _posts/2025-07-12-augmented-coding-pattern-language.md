...
Leading emojis are what LLMs are known for. They're a sign that something might have been generated by an LLM. They carry meaning but use minimal space.
Provides: Feedback on the current state in the process.

Provides: When it's missing, you know the agent starts forgetting things and there is context drift.
